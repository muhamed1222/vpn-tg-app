...
const ALL_FAQS: FAQ[] = [
  ...
  { 
    ...
    answer: "Проверьте лимиты вашего банка на онлайн-транзакции. Если деньги списались, но подписка не обновилась, свяжитесь с поддержкой @outlivion_supportbot, приложив скриншот или ID инвойса. Обычно платежи обрабатываются в течение 5-10 минут." 
  },
  { 
    id: '3', 
    category: 'Платежи', 
